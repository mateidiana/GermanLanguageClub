...
public class VocabularyController {
    ...
    public List<Word> practicePastMistakes(int studentId){return vocabService.practicePastMistakes(studentId);}

    public String handlePastMistakesAnswer(int studentId, int questionId, String answer){return vocabService.handlePastMistakesAnswer(studentId,questionId,answer);}
    ...
    public void createQuestion(int courseId, String question, String rightAnswer){vocabService.createQuestion(courseId,question,rightAnswer);}
